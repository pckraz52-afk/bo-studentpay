...
const DashboardEvolutionDepot: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    api.transactions
      .getAll({ type: TransactionType.DEPOSIT })
    ...
    <div>
      ...
      <div className="bg-white rounded-xl p-5 shadow-sm border border-slate-100" style={{ minHeight: 340 }}>
        ...
        <div className="flex flex-wrap items-end justify-between gap-4 mb-5">
          <div>
            <div className="text-xs text-slate-400 uppercase tracking-wide mb-0.5">Total dépôts</div>
...
export default DashboardEvolutionDepot;